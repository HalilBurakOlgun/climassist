            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <li class="nav-item">
                            <a href="reset_password.php" class="btn btn-primary ms-3">Şifreyi Yenile</a>
                        </li>
...
>>>>>>> 5d74e715077eb81489b8b38e13c1ca6ed305b304
 ...
 <!-- End NedenBiz -->
  ...
  <!-- ======= Counts Section ======= -->
    ...
    <!-- End Counts Section -->
     ...
     <!-- ======= Gallery Section ======= -->
    <section style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px; padding: 40px; background-color: #f8f9fa;">
      <div style="flex: 0 1 22%; min-width: 250px; background-color: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        <p style="color: #101460; font-size: 22px; font-weight: bold; margin-bottom: 10px;">#1 Projelendirme ve Bütçeleme</p>
        <p style="font-size: 18px; line-height: 1.6;">Projelendirme ve bütçeleme süreçlerinizde sunacağımız uzman destek ile projenizi güvenle yönetin.</p>
      </div>
      <div style="flex: 0 1 22%; min-width: 250px; background-color: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        <p style="color: #101460; font-size: 22px; font-weight: bold; margin-bottom: 10px;">#2 VRF ve Mekanik Uygulamalar</p>
        <p style="font-size: 18px; line-height: 1.6;">VRF, havalandırma ve yangın sistemlerinde yüksek kaliteli mekanik uygulamalarımızla konforlu ortamlar oluşturun.</p>
      </div>
      <div style="flex: 0 1 22%; min-width: 250px; background-color: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        <p style="color: #101460; font-size: 22px; font-weight: bold; margin-bottom: 10px;">#3 Enerji Tasarrufu</p>
        <p style="font-size: 18px; line-height: 1.6;">İşletmenizin sürdürülebilirliği için enerji tasarruflu çözümlerimiz ve çevreci uygulamalarımızdan faydalanın.</p>
      </div>
      <div style="flex: 0 1 22%; min-width: 250px; background-color: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        <p style="color: #101460; font-size: 22px; font-weight: bold; margin-bottom: 10px;">#4 Tesis Yönetimi</p>
        <p style="font-size: 18px; line-height: 1.6;">Profesyonel tesis yönetimi ile zamanınızı ve kaynaklarınızı en verimli şekilde kullanın.</p>
      </div>
      <div style="flex: 0 1 22%; min-width: 250px; background-color: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        <p style="color: #101460; font-size: 22px; font-weight: bold; margin-bottom: 10px;">#5 Teknik Servis</p>
        <p style="font-size: 18px; line-height: 1.6;">Teknik servis çözümlerimizle işletmenizde kesintisiz hizmet ve konforlu çalışma ortamı sağlayın.</p>
      </div>
      <div style="flex: 0 1 22%; min-width: 250px; background-color: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        <p style="color: #101460; font-size: 22px; font-weight: bold; margin-bottom: 10px;">#6 Periyodik Bakım</p>
        <p style="font-size: 18px; line-height: 1.6;">Önleyici ve periyodik bakım hizmetlerimizle arızalara karşı bir adım önde olun.</p>
      </div>
      <div style="flex: 0 1 22%; min-width: 250px; background-color: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        <p style="color: #101460; font-size: 22px; font-weight: bold; margin-bottom: 10px;">#7 Faturalama ve Otomasyon</p>
        <p style="font-size: 18px; line-height: 1.6;">Faturalama ve otomasyon süreçlerinizde iş yükünüzü hafifletiyoruz, siz işinize odaklanın.</p>
      </div>
      <div style="flex: 0 1 22%; min-width: 250px; background-color: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        <p style="color: #101460; font-size: 22px; font-weight: bold; margin-bottom: 10px;">#8 Profesyonel Yaklaşım</p>
        <p style="font-size: 18px; line-height: 1.6;">Kapsamlı hizmetlerimiz ve profesyonel yaklaşımımız ile operasyonel ihtiyaçlarınıza güçlü bir çözüm ortağıyız.</p>
      </div>
    </section>
<!-- End Gallery Section -->
